...
class QuestionBank(models.Model):
    ...
    tenant = models.ForeignKey('tenancy.Tenant', on_delete=models.CASCADE, related_name='questionbank_questions')
...
class ControlQuestionMap(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    tenant = models.ForeignKey('tenancy.Tenant', on_delete=models.CASCADE, related_name='questionbank_control_maps')
...
class QuestionApplicabilityRule(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    tenant = models.ForeignKey('tenancy.Tenant', on_delete=models.CASCADE, related_name='questionbank_applicability_rules')
